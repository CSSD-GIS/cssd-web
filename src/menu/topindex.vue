<template>
  <div class="clear">
    <div class="top">
      ...
      <!-- <router-link :to="{ path: '/views/realTime', query: { name: 'detection' }  }">为了测试上传而注释 -->
      <router-link
        :to="{ path: '/views/realTime', query: { name: 'detection' } }"
      >
        <el-dropdown placement="bottom">
          ...
          <el-dropdown-menu slot="dropdown">
            ...
            <router-link :to="{ path: '/views/realTime', query: { id: '5' } }">
      ...
      <router-link
        :to="{ path: '/views/realTime', query: { name: 'realTime' } }"
      >
...
@font-face {
  ...
  src: url("../assets/css/font/ds-digi-webfont.woff2") format("woff2"),
    url("../assets/css/font/ds-digi-webfont.woff") format("woff");
  font-weight: normal;
  font-style: normal;
}
.clear {
