<template>
  <div class="classroom">
    ...
    <dv-border-box-8 class="outbox" style="height:450px;overflow: hidden; margin-top:50px">
      ...
      <marquee class="content1" width="100%" height="400px" direction="up" behavior="scroll" scrolldelay="10000" scrollamount="250" on-mouse-out="this.start()" on-mouse-over="this.stop()">
        <div v-for=" val in textbook " :key="val" class="text">{{ val }}
          <div class="link-top" />
        </div>
      </marquee>
    </dv-border-box-8>
